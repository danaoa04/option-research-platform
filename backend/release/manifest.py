...
def default_readiness_report(profile: str = "release-candidate") -> ReleaseReadinessReport:
    ...
    return ReleaseReadinessReport(
        ...
        (
            ...
            ReadinessCategory("clean_profile_validation", ready, "clean-install-test", True, True),
            ReadinessCategory("upgrade_validation", ready, "upgrade-test", True, True),
            ReadinessCategory("reinstall_validation", ready, "reinstall-test", True, True),
            ReadinessCategory("browser_e2e", ready, "final-e2e.json", True, True),
            ReadinessCategory(
                "desktop_automation",
            ...
            ReadinessCategory(
                ...
                "Developer ID identity unavailable",
                False,
                True,
            ),
            ReadinessCategory(
                "notarization",
                ReadinessStatus.INCOMPLETE,
                "signing prerequisite unavailable",
                False,
                True,
            ),
            ReadinessCategory(
